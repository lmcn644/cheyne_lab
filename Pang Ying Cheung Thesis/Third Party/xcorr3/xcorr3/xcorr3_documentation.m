...
% The |xcorr3| function gives a map of correlation between grid cells of a 3D spatiotemporal dataset 
...
% time lags corresponding to maximum correlation.  
% 
...
% reference sinusoid.  (Below I'm using <https://www.mathworks.com/matlabcentral/fileexchange/61293 |imagescn|> 
% to create an |imagesc| plot where NaN values are transparent, but you can use |imagesc| or 
% |pcolor| if you prefer.  I'm also using a <https://www.mathworks.com/matlabcentral/fileexchange/57773-cmocean-perceptually-uniform-colormaps/content/cmocean/html/cmocean_documentation.html 
...
% <https://www.mathworks.com/matlabcentral/fileexchange/50390-borders/content/borders/html/borders_documentation.html |borders|> 
% for context: 
...
borders('countries','facecolor',rgb('tan'),'nomappingtoolbox')
